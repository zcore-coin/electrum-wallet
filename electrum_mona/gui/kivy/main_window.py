...
Label.register('Roboto',
               'electrum_mona/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_mona/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_mona/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrum_mona/gui/kivy/data/fonts/Roboto-Bold.ttf')
Label.register('JP',
               'electrum_mona/gui/kivy/data/fonts/mplus-2p-regular.ttf',
               'electrum_mona/gui/kivy/data/fonts/mplus-2p-regular.ttf',
               'electrum_mona/gui/kivy/data/fonts/mplus-2p-bold.ttf',
               'electrum_mona/gui/kivy/data/fonts/mplus-2p-bold.ttf')


from electrum_mona.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def build(self):
        return Builder.load_file('electrum_mona/gui/kivy/main.kv')
    ...
    def on_start(self):
        ...
        # bind intent for zcore: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_mona/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-ZCore', message,
                            app_icon=icon, app_name='Electrum-ZCore')
        except ImportError:
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_mona/gui/kivy/theming/light/card'
        else:
