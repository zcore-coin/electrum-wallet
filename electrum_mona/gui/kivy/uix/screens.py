...
from electrum_mona.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrum_mona.util import PR_TYPE_ADDRESS, PR_TYPE_LN, PR_TYPE_BIP70
from electrum_mona import bitcoin, constants
from electrum_mona.transaction import TxOutput, Transaction, tx_from_str
from electrum_mona.util import send_exception_to_crash_reporter, parse_URI, InvalidBitcoinURI
from electrum_mona.util import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED, TxMinedInfo, get_request_status, pr_expiration_values
...
class CScreen(Factory.Screen):
    ...
    def load_screen(self):
        self.screen = Builder.load_file('electrum_mona/gui/kivy/uix/ui_screens/' + self.kvname + '.kv')
...
class HistoryScreen(CScreen):
    ...
    def get_card(self, tx_item): #tx_hash, tx_mined_status, value, balance):
        ...
        if is_lightning:
            ...
            icon = "atlas://electrum_mona/gui/kivy/theming/light/lightning"
            ...
            icon = "atlas://electrum_mona/gui/kivy/theming/light/" + TX_ICONS[status]
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_mona.util import create_bip21_uri
