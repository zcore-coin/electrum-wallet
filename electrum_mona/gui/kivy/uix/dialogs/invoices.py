...
<InvoiceItem@CardItem>
    ...
    status: ''
    date: ''
    icon: 'atlas://electrum_mona/gui/kivy/theming/light/important'
    Image:
        id: icon
        source: root.icon
        size_hint: None, 1
...
from electrum_mona.gui.kivy.uix.context_menu import ContextMenu
...
pr_icon = {
    PR_UNPAID: 'atlas://electrum_mona/gui/kivy/theming/light/important',
    PR_UNKNOWN: 'atlas://electrum_mona/gui/kivy/theming/light/important',
    PR_PAID: 'atlas://electrum_mona/gui/kivy/theming/light/confirmed',
    PR_EXPIRED: 'atlas://electrum_mona/gui/kivy/theming/light/close'
}
