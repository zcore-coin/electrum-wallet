...
try:
    from electrum_mona.crypto import sha256d, EncodeAES_base64, DecodeAES_base64
    from electrum_mona.bitcoin import (TYPE_ADDRESS, push_script, var_int, public_key_to_p2pkh,
                                  is_address)
    from electrum_mona.bip32 import serialize_xpub, deserialize_xpub
    ...
    from electrum_mona.util import print_error, to_string, UserCancelled, UserFacingException
...
class DigitalBitboxPlugin(HW_PluginBase):
    ...
    def setup_device(self, device_info, wizard, purpose):
        ...
        client.get_xpub("m/44'/22'", 'standard')
