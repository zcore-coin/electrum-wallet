...
from electrum_mona.bip32 import serialize_xpub, deserialize_xpub, InvalidMasterKeyVersionBytes
from electrum_mona.i18n import _
from electrum_mona.plugin import Device
from electrum_mona.keystore import Hardware_KeyStore, xpubkey_to_pubkey, Xpub
...
from electrum_mona.util import print_error, bfh, bh2u, versiontuple, UserFacingException
...
try:
    ...
    class ElectrumColdcardDevice(ColdcardDevice):
        ...
        def mitm_verify(self, sig, expect_xpub):
            ...
            from electrum_mona.ecc import ECPubkey
