Electrum-ZCore - Lightweight ZCore client
=====================================
...
::
  ...
  Port Maintainer: WakiyamaP (Electrum-ZCore)
  Language: Python (>= 3.6)
...
Electrum-ZCore is a pure python application. If you want to use the
...
Electrum-ZCore from its root directory without installing it on your
system; all the python dependencies are included in the 'packages'
directory. To run Electrum-ZCore from its root directory, just do::

    ./run_electrum

You can also install Electrum-ZCore on your system, by running this command::

    sudo apt-get install python3-setuptools
    python3 -m pip install .[fast]

This will download and install the Python dependencies used by
Electrum-ZCore instead of using the 'packages' directory.
The 'fast' extra contains some optional dependencies that we think
are often useful but they are not strictly needed.

If you cloned the git repository, you need to compile extra files
before you can run Electrum-ZCore. Read the next section, "Development
Version".
