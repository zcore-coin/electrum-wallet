...
from electrum_mona_gui.kivy.nfc_scanner import NFCBase
...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_mona.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_mona"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_mona:externalType",
                '',
                data)
        return extRecord
