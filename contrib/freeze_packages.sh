...
pip freeze | sed '/^Electrum-MONA/ d' > $contrib/deterministic-build/requirements.txt
...
pip freeze | sed '/^Electrum-MONA/ d' > $contrib/deterministic-build/requirements-hw.txt
